...
const getHelpCategories = (t: (key: string) => string) => [
  {
    ...
    description: t("New to MathMaster? Learn the basics and set up your account."),
    color: "violet",
    links: [
      { text: t("Creating your account"), href: "/auth" },
      { text: t("Setting up your profile"), href: "/dashboard" },
      { text: t("Navigating the platform"), href: "/about" }
    ],
  ...
  },
  {
    ...
    description: t("Manage your account, preferences, and privacy settings."),
    color: "purple",
    links: [
      { text: t("Update your profile"), href: "/dashboard" },
      { text: t("Change password"), href: "/auth" },
      { text: t("Notification settings"), href: "/dashboard" }
    ],
  ...
  },
  {
    ...
    description: t("Troubleshoot issues and get help with technical problems."),
    color: "blue",
    links: [
      { text: t("Browser compatibility"), href: "#faq" },
      { text: t("Report a bug"), href: "#contact" },
      { text: t("System requirements"), href: "#faq" }
    ],
  ...
  },
  {
    icon: Users,
    title: t("Community"),
    description: t("Connect with other learners and share knowledge."),
    color: "yellow",
    links: [
...
const getFaqs = (t: (key: string) => string) => [
  {
    ...
    answer: t('To reset your password, click on the "Forgot Password" link on the login page. Enter your email address, and we\'ll send you instructions to create a new password.'),
  },
  {
    question: t("How do I book a tutoring session?"),
    answer: t('Go to the Schedule page and click "Book Session". You can browse available tutors, view their profiles, and select a time that works for you.'),
  },
  {
    question: t("Is MathMaster free to use?"),
    answer: t("Yes! MathMaster offers free access to resources, community forums, and study materials. Some premium features like one-on-one tutoring may have associated costs."),
  },
  {
    question: t("How can I become a tutor?"),
    answer: t("If you're interested in becoming a peer tutor, contact our support team with your qualifications. We'll review your application and get back to you within 48 hours."),
  },
];

const getContactMethods = (t: (key: string) => string) => [
  { icon: Mail, title: t("Email Us"), description: "support@mathmaster.com", action: t("Send Email"), href: "mailto:support@mathmaster.com" },
  { icon: MessageCircle, title: t("Live Chat"), description: t("Available 24/7"), action: t("Start Chat"), href: "#contact" },
  { icon: Phone, title: t("Call Us"), description: "+1 (555) 123-4567", action: t("Call Now"), href: "tel:+15551234567" },
];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 md:py-12 pb-24 md:pb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-16">
          ...
          >
            ...
            <h3 className="text-lg font-semibold mb-2">{t("Can't find what you need?")}</h3>
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">{t("Full Name *")}</label>
                        <Input placeholder={`${t("Malhar")} ${t("Pawar")}`} required />
                      </div>
                      <div>
                        <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">{t("Email Address *")}</label>
                    ...
                    <div>
                      ...
                      <Input placeholder={t("How can we help you?")} required />
                    </div>
                    
                    <div>
                      <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">{t("Message *")}</label>
                      <Textarea rows={6} placeholder={t("Describe your issue or question in detail...")} required />
                    </div>
