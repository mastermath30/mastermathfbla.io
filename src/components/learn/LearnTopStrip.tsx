  ...
  return (
    <div className="learn-top-strip sticky top-20 md:top-24 z-30">
      <div className="learn-top-strip-inner">
        <div>
          <p className="learn-top-strip-label">Current Mission</p>
        ...
        <div className="learn-top-strip-stats">
          ...
          <div className="learn-pill">
            ...
            <span suppressHydrationWarning>{xpToNext} XP to next</span>
          </div>
        </div>

        <div className="learn-top-strip-progress" aria-label="XP progress">
          <div className="learn-top-strip-track">
            <div className="learn-top-strip-fill" style={{ width: `${progressPct}%` }} />
          </div>
          <span className="learn-top-strip-xp" suppressHydrationWarning>{xpToday}/100 XP today</span>
        </div>
