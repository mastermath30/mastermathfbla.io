...
const allTutors = [
  {
    ...
    reviews: 128,
    price: 52,
    image: "/images/people/sarah-johnson.svg",
    available: true,
    experience: "8 years",
  ...
  },
  {
    ...
    reviews: 96,
    price: 35,
    image: "/images/people/priya-patel.svg",
    available: true,
    experience: "5 years",
    education: "MS Mathematics, Stanford",
    specialties: ["Linear Algebra", "Geometry", "SAT/ACT Prep"],
  ...
  },
  {
    ...
    reviews: 84,
    price: 29,
    image: "/images/people/michael-chen.svg",
    available: true,
    experience: "4 years",
  ...
  },
  {
    ...
    reviews: 112,
    price: 42,
    image: "/images/people/emma-rodriguez.svg",
    available: true,
    experience: "6 years",
  ...
  },
  {
    ...
    reviews: 73,
    price: 38,
    image: "/images/people/alex-thompson.svg",
    available: true,
    experience: "3 years",
  ...
  },
  {
    ...
    reviews: 89,
    price: 48,
    image: "/images/people/jessica-wu.svg",
    available: true,
    experience: "7 years",
  ...
  },
  {
    ...
    reviews: 67,
    price: 44,
    image: "/images/people/david-kim.svg",
    available: true,
    experience: "5 years",
  ...
  },
  {
    ...
    reviews: 95,
    price: 32,
    image: "/images/people/maria-santos.svg",
    available: true,
    experience: "4 years",
  ...
  },
  {
    ...
    reviews: 78,
    price: 40,
    image: "/images/people/robert-foster.svg",
    available: true,
    experience: "6 years",
    education: "MS Mathematics, Princeton",
    specialties: ["Geometry", "Trigonometry", "SAT/ACT Prep"],
  ...
  },
  {
    ...
    reviews: 85,
    price: 46,
    image: "/images/people/lisa-zhang.svg",
    available: true,
    experience: "5 years",
  ...
  },
  {
    ...
    reviews: 92,
    price: 36,
    image: "/images/people/james-wilson.svg",
    available: true,
    experience: "4 years", 
  ...
  },
  {
    ...
    reviews: 76,
    price: 48,
    image: "/images/people/rachel-green.svg",
    available: true,
    experience: "9 years",
...
export function TutorBookingBrowser({
  backHref = "/schedule",
  backLabel = "Back to Schedule",
  sectionLabel = "Our Tutors",
  title = "Expert Math Tutors",
  accentTitle = "Ready to Help",
  description = "Connect with experienced peer tutors and professionals who are passionate about helping you succeed in mathematics.",
  authRedirect = "/tutors",
}: TutorBookingBrowserProps) {
  ...
  const handleBookNow = (tutor: typeof allTutors[0]) => {
    if (!isLoggedIn) {
      router.push(`/auth?redirect=${encodeURIComponent(authRedirect)}&action=book`);
      return;
    }
